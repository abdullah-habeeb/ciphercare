...
def main():
    ...
    data_path = str(PROJECT_ROOT / "src" / "hospital_e" / "data")
    try:
        ...
        # Fuse all three modalities. UnifiedFLModel crops/pads whatever width
        # results down to its fixed 1200-dim input, so exact width doesn't
        # matter -- but X_lungs was being loaded and then silently discarded
        # here, meaning Hospital E's whole modality never reached the model.

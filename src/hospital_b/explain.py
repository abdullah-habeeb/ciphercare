...
if __name__ == "__main__":
    ...
    MODEL_PATH = str(PROJECT_ROOT / "ml" / "models" / "hospital2_model.pth")
    CSV_PATH = str(PROJECT_ROOT / "data" / "hospital_b" / "processed_vitals.csv")
    OUTPUT_PATH = str(PROJECT_ROOT / "ml" / "shap" / "hospital2_shap.png")
